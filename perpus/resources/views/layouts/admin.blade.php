...
<body class="hold-transition sidebar-mini">
    ...
    <div class="wrapper">
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link" data-toggle="dropdown" href="#">
                        ...
                        <span class="badge badge-warning navbar-badge">{{ getNotif_helper() }}</span>
                   ...
                   with font-awesome or any other icon font library -->
                        ...
                        {{-- <li class="nav-item">
                            <a href="{{ url('transactiondetail') }}"
                                class="nav-link {{ request()->is('transactiondetail') ? 'active' : '' }}">
        ...
        <footer class="main-footer">
            ...
            <strong>Copyright &copy; 2023 <a href="https://adminlte.io">Rahmat</a>.</strong>
        </footer>
